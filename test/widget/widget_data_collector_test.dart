...
void main() {
  ...
  test('mapToSnapshot übernimmt Phase-2-Felder (benannte Defaults)', () {
    final snap = WidgetDataCollector.mapToSnapshot(
      ...
      carbs: 180,
      fat: 60,
      lastMeal: 'Haferflocken',
      nextWorkout: 'Push A',
      weeklyVolume: 12000,
      trainingStreak: 4,
      openTodos: 3,
      nextAppointment: 'Zahnarzt 14:00',
      habitsDone: 2,
      habitsTotal: 5,
      medsDone: 1,
      medsTotal: 2,
      ...
      budgetSpent: 800,
      budgetLimit: 1000,
      topCategory: 'Lebensmittel',
      writeStreak: 6,
      lastEntry: 'Guter Tag',
      entriesThisMonth: 12,
      abstinenceTitle: 'Alkohol',
      abstinenceDuration: '14 Tage',
      moneySaved: 120,
      lastIntake: 'Magnesium',
      takenToday: 2,
      cycleDay: 12,
      periodPhase: 'Follikelphase',
      nextPeriodDays: 16,
      notesCount: 23,
      lastNote: 'Einkaufsliste',
      placesCount: 8,
      lastPhoto: 'Hauptbahnhof',
    );
  ...
  test(
    'mapToSnapshot übernimmt v2-Serien und toStringMap enthält die CSV-Strings',
    () {
      final snap = WidgetDataCollector.mapToSnapshot(
        stepsToday: 0,
        stepsGoal: 10000,
