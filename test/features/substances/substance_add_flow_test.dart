...
void main() {
  testWidgets('opens the medication sheet prefilled for klasse=medikament', (
    tester,
  ) async {
    ...
    final record = SubstanceRecord(
      ...
      dosierung: const DosierungNachAltersgruppe(
        erwachseneDe: '200-400 mg alle 6-8h',
      ),
    );
              ...
              body: Consumer(
                builder: (context, ref, _) {
                  return ElevatedButton(
                    ...
                    onPressed: () =>
                        showSubstanceDetailSheet(context, ref, record),
