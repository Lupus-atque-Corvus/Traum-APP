...
void main() {
  ...
  testWidgets('shows the title and renders markdown from a real asset', (
    ...
    await tester.pumpWidget(
      _wrap('assets/legal/privacy_policy_de.md', 'Datenschutz'),
    );
    await tester.pump();
  ...
  testWidgets(
    'shows a friendly error instead of crashing for a missing asset',
    (tester) async {
      await tester.pumpWidget(_wrap('assets/legal/does_not_exist.md', 'Fehlt'));
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 50));
