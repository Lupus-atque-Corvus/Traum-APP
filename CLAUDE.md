...
> Repo: **Lupus-atque-Corvus/Traum-APP** · Version **0.7.18+67** · schemaVersion **18**.
> Alle Angaben unten sind direkt aus dem Quellcode dieses Repos verifiziert (Stand v0.7.18).
...
- **Version:** 0.7.18+67 · Drift schemaVersion: 18
...
> (`Traum-APP`, v0.7.18) ist der aktuelle, weiter entwickelte Stand (19 Module, embedded DM Sans,
