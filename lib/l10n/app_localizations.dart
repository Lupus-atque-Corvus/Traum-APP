...
abstract class AppLocalizations {
  ...
  /// No description provided for @mapImportTowersTooltip.
  ///
  /// In de, this message translates to:
  /// **'Funkmasten importieren'**
  String get mapImportTowersTooltip;

  /// No description provided for @mapImportTowersTitle.
  ///
  /// In de, this message translates to:
  /// **'Funkmasten aus OpenStreetMap importieren'**
  String get mapImportTowersTitle;

  /// No description provided for @mapImportAreaViewport.
  ///
  /// In de, this message translates to:
  /// **'Aktueller Kartenausschnitt'**
  String get mapImportAreaViewport;

  /// No description provided for @mapImportAreaRegion.
  ///
  /// In de, this message translates to:
  /// **'Region/Land'**
  String get mapImportAreaRegion;

  /// No description provided for @mapImportRegionHint.
  ///
  /// In de, this message translates to:
  /// **'z. B. \"Bayern\", \"Deutschland\"'**
  String get mapImportRegionHint;

  /// No description provided for @mapImportStartButton.
  ///
  /// In de, this message translates to:
  /// **'Import starten'**
  String get mapImportStartButton;

  /// No description provided for @mapImportProgress.
  ///
  /// In de, this message translates to:
  /// **'{imported} importiert · {skipped} übersprungen · {errors} Fehler / {total}'**
  String mapImportProgress(int imported, int skipped, int errors, int total);

  /// No description provided for @mapImportDone.
  ///
  /// In de, this message translates to:
  /// **'Import abgeschlossen'**
  String get mapImportDone;

  /// No description provided for @mapImportCloseButton.
  ///
  /// In de, this message translates to:
  /// **'Fertig'**
  String get mapImportCloseButton;

  /// No description provided for @mapImportErrorNetwork.
  ///
  /// In de, this message translates to:
  /// **'Keine Verbindung zu OpenStreetMap möglich. Bitte später erneut versuchen.'**
  String get mapImportErrorNetwork;

  /// No description provided for @mapImportErrorHttp.
  ///
  /// In de, this message translates to:
  /// **'Der OpenStreetMap-Dienst antwortete mit einem Fehler.'**
  String get mapImportErrorHttp;

  /// No description provided for @mapImportErrorRegionNotFound.
  ///
  /// In de, this message translates to:
  /// **'Region nicht gefunden. Bitte Namen prüfen (z. B. \"Bayern\").'**
  String get mapImportErrorRegionNotFound;

  /// No description provided for @mapImportErrorUnknown.
  ///
  /// In de, this message translates to:
  /// **'Unbekannter Fehler beim Import.'**
  String get mapImportErrorUnknown;
