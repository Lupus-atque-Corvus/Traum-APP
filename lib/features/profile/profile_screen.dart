        ...
        children: [
          ...
          sleepAsync.when(
            data: (logs) {
              ...
              final avgMinutes =
                  logs
                      .map((l) => l.wakeTime.difference(l.bedtime).inMinutes)
                      .fold(0, (s, m) => s + m) ~/
                  logs.length;
              ...
              final avgQuality = logs.isEmpty
                  ? 0.0
                  : logs.fold(0, (s, l) => s + (l.qualityStars ?? 0)) /
                        logs.length;
              return Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    Text(
                      mood.moodScore <= 5
                          ? moodEmojis[mood.moodScore.clamp(1, 5)]
                          : '😐',
