...
class ShoppingTemplatesSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final templates = ref.watch(shoppingTemplatesStreamProvider).value ?? [];
    return Padding(
        ...
        children: [
          ...
          if (templates.isEmpty)
            Padding(
              ...
              child: Text(
                AppLocalizations.of(context)!.noTemplatesSaved,
                style: TextStyle(
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Center(
                child: Text(
                  '+ Aktuelle Liste als Vorlage speichern',
                  style: TextStyle(
