  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            TraumSubHeader(title: AppLocalizations.of(context)!.inStore),
            Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                AppLocalizations.of(
                                  context,
                                )!.inCartStatus(inCart, items.length),
                              ...
                              Text(
                                AppLocalizations.of(
                                  ...
                                  '${_estTotal(items).toStringAsFixed(2).replaceAll('.', ',')} €',
                                ),
                                style: const TextStyle(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              initialValue:
                  item.priceActual?.toStringAsFixed(2).replaceAll('.', ',') ??
                  '',
