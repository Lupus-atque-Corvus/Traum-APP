...
class AmountEntrySheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AmountEntrySheet> createState() => _AmountEntrySheetState();
}

class _AmountEntrySheetState extends ConsumerState<AmountEntrySheet> {
  ...
  double get _calories => widget.product.caloriesPer100g * _factor;
  double get _protein => widget.product.proteinPer100g * _factor;
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _MacroRow('Protein', _protein, 160, TraumColors.indigoBlue, 'g'),
            _MacroRow('Carbs', _carbs, 250, TraumColors.amberGold, 'g'),
            _MacroRow('Fett', _fat, 70, TraumColors.cyanBlue, 'g'),
            const SizedBox(height: 20),
            SizedBox(
              height: 50,
...
class _MacroRow extends StatelessWidget {
  ...
  const _MacroRow(this.label, this.value, this.goal, this.color, this.unit);
        ...
        Expanded(
          child: ClipRRect(
            ...
            child: LinearProgressIndicator(
              value: (goal > 0 ? value / goal : 0.0).clamp(0.0, 1.0).toDouble(),
              minHeight: 6,
