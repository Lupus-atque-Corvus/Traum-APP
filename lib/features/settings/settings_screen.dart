...
class _CalendarSyncSection extends ConsumerStatefulWidget {
  @override
  ConsumerState<_CalendarSyncSection> createState() =>
      _CalendarSyncSectionState();
}
      ...
      child: Column(
        children: [
          _GoalTile(
            ...
            value: '$kcal kcal',
            onTap: () =>
                _editIntDialog(context, l10n.kcalGoalLabel, kcal, 'kcal', (v) {
          ...
          _GoalTile(
            ...
            onTap: () =>
                _editDoubleDialog(context, l10n.weightGoalCm, weightGoal, (v) {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return _Section(
      ...
      child: SwitchListTile(
        ...
        onChanged: (v) =>
            ref.read(isPeriodTrackingEnabledProvider.notifier).set(v),
      ),
    );
  }
}
...
class _ExperimentalSectionState extends ConsumerState<_ExperimentalSection>
  ...
  Future<void> _onSetLauncher() async {
    ...
    if (!ok) {
      messenger.showSnackBar(SnackBar(content: Text(l10n.setAsLauncherFailed)));
    }
      ...
      child: Column(
        children: [
          SwitchListTile(
            ...
            value: biometricLock,
            activeThumbColor: TraumColors.coralOrange,
            inactiveThumbColor: _biometricAvailable
                ? null
                : TraumColors.onBackgroundSubtle,
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            label: Text(
              '${l10n.exportSelected} (${_format.toUpperCase()})',
              style: const TextStyle(
                fontFamily: 'DMSans',
                fontWeight: FontWeight.w600,
              ),
