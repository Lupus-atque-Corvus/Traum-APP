  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: TraumColors.background,
        title: Text(
          AppLocalizations.of(context)!.workoutDetails,
        ...
        data: (sets) => exercisesAsync.when(
          data: (exercises) {
            if (sets.isEmpty) {
              return Center(
                child: Text(
                  AppLocalizations.of(context)!.noSetsRecorded,
                  style: const TextStyle(
          ...
          ...sets.map(
            (s) => Padding(
              ...
              child: Row(
                children: [
                  Text(
                    AppLocalizations.of(context)!.setLabel(s.setNumber),
                    style: const TextStyle(
                      color: TraumColors.onBackgroundMuted,
                      fontFamily: 'DMSans',
                      fontSize: 12,
                  ...
                  if (s.reps != null)
                    Text(
                      AppLocalizations.of(context)!.repsCount(s.reps!),
                      style: const TextStyle(
                        color: TraumColors.onBackground,
                        fontFamily: 'DMSans',
                        fontWeight: FontWeight.w500,
