                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (ctx, i) => _SavingsGoalCard(
                      ...
                      onDelete: () => ref
                          ...
                          .deleteSavingsGoal(goals[i].id),
                      onAddAmount: (amount) =>
                          _addToGoal(ref, goals[i], amount),
                    ),
                  );
                },
  ...
  void _showDepositDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: TraumColors.surfaceElevated,
        title: Text(
          AppLocalizations.of(ctx)!.depositAmount,
          style: const TextStyle(
            color: TraumColors.onBackground,
            fontFamily: 'DMSans',
          ),
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text(
              AppLocalizations.of(ctx)!.deposit,
              style: const TextStyle(
                color: TraumColors.mintGreen,
                fontWeight: FontWeight.w700,
              ),
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text(
                AppLocalizations.of(context)!.targetDateOptional,
                style: const TextStyle(
                  color: TraumColors.onBackgroundMuted,
                  fontFamily: 'DMSans',
                  fontSize: 13,
            ...
            _buildTextField(
              AppLocalizations.of(context)!.fieldNoteOptional,
              _noteCtrl,
  ...
  Future<void> _save() async {
    ...
    if (target == null || target <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            AppLocalizations.of(context)!.pleaseEnterValidTargetAmount,
          ),
        ),
      );
      return;
