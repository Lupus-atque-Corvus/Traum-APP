...
final Map<String, _Showcase> _kShowcases = {
  'substances': _Showcase(
    ...
    TraumColors.gradientSupplements,
    (l) => l.obSubstancesTitle,
    (l) => l.obSubstancesSubtitle,
    [
      (l) => l.obSubstancesFeature1,
      (l) => l.obSubstancesFeature2,
      (l) => l.obSubstancesFeature3,
    ],
  ),
  'planning': _Showcase(
    Icons.checklist_rounded,
    TraumColors.lavender,
    TraumColors.gradientPlanning,
    (l) => l.obPlanningTitle,
    (l) => l.obPlanningSubtitle,
    [
      (l) => l.obPlanningFeature1,
      (l) => l.obPlanningFeature2,
      (l) => l.obPlanningFeature3,
    ],
  ),
  'diary': _Showcase(
  ...
  'healthScore': _Showcase(
    ...
    TraumColors.cyanBlue,
    TraumColors.gradientCool,
    (l) => l.obHealthScoreTitle,
    (l) => l.obHealthScoreSubtitle,
    [
      (l) => l.obHealthScoreFeature1,
      (l) => l.obHealthScoreFeature2,
      (l) => l.obHealthScoreFeature3,
    ],
  ),
};
