...
class _SubstanceDetailSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_SubstanceDetailSheet> createState() => _SubstanceDetailSheetState();
}
          ...
          children: [
            ...
            Center(
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: TraumColors.onBackgroundSubtle, borderRadius: BorderRadius.circular(2))),
            ),
            ...
            Row(children: [
              Container(
                ...
                child: Icon(isMed ? Icons.medication_rounded : Icons.science_rounded,
                    color: isMed ? TraumColors.roseRed : TraumColors.indigoBlue, size: 22),
              ),
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Wrap(spacing: 6, runSpacing: 4, children: [
                    _Badge(
                        label: isMed ? l10n.substanceKlasseMed : l10n.substanceKlasseSupp,
                        color: isMed ? TraumColors.roseRed : TraumColors.indigoBlue),
                    if (record.kategorie != null)
                      _Badge(label: record.kategorie!, color: TraumColors.lavender),
                    _Badge(
                        label: _statusLabel(l10n, record.datenStatus),
                        color: _statusColor(record.datenStatus)),
                    if (record.pflanzlich)
                      _Badge(label: '🌿 ${l10n.substancePflanzlich}', color: TraumColors.mintGreen),
                  ]),
                ]),
              ),
            ]),
            ...
            Wrap(spacing: 8, children: [
              _JumpChip(label: l10n.substanceSectionEffekt, onTap: () => _jumpTo(_effektKey)),
              _JumpChip(
                  label: l10n.substanceSectionWechselwirkungen,
                  onTap: () => _jumpTo(_wechselwirkungenKey)),
              _JumpChip(label: l10n.substanceSectionDosierung, onTap: () => _jumpTo(_dosierungKey)),
              _JumpChip(label: l10n.substanceSectionChemie, onTap: () => _jumpTo(_chemieKey)),
            ]),
            const SizedBox(height: 20),
            _Field(label: l10n.substanceFieldBeschreibung, value: record.beschreibung(lang)),
            Container(key: _effektKey),
            _Field(label: l10n.substanceFieldEffekt, value: record.effekt(lang)),
            _Field(label: l10n.substanceFieldIndikation, value: record.indikation(lang)),
            Container(key: _wechselwirkungenKey),
            _WechselwirkungenBlock(text: record.wechselwirkungen(lang), l10n: l10n),
            _Field(label: l10n.substanceFieldWarnungen, value: record.warnungen(lang)),
            _Field(
            ...
            _ChemieSection(
                ...
                onToggle: () => setState(() => _chemieExpanded = !_chemieExpanded),
                l10n: l10n),
            ...
            SizedBox(
              ...
              child: FilledButton(
                ...
                child: Text(l10n.substanceAddToMyMeds,
...
class _Badge extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration:
            BoxDecoration(color: color.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(20)),
        child: Text(label,
            style: TextStyle(
                color: color, fontFamily: 'DMSans', fontSize: 11, fontWeight: FontWeight.w600)),
      );
}
...
class _JumpChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Container(
          ...
          decoration:
              BoxDecoration(color: TraumColors.surface, borderRadius: BorderRadius.circular(TraumRadius.chip)),
          child: Text(label,
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label,
            style: const TextStyle(
                color: TraumColors.onBackground, fontFamily: 'DMSans', fontWeight: FontWeight.w700, fontSize: 14)),
        const SizedBox(height: 6),
        Text(value!,
            style: const TextStyle(
                color: TraumColors.onBackgroundMuted, fontFamily: 'DMSans', fontSize: 13, height: 1.5)),
      ]),
    );
  }
}
...
class _WechselwirkungenBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 16),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(l10n.substanceSectionWechselwirkungen,
            style: const TextStyle(
                color: TraumColors.onBackground, fontFamily: 'DMSans', fontWeight: FontWeight.w700, fontSize: 14)),
        const SizedBox(height: 6),
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(left: BorderSide(color: TraumColors.roseRed, width: 3)),
          ),
          child: Text(
            text != null && text!.trim().isNotEmpty ? text! : l10n.substanceKeineAngabe,
            style: TextStyle(
...
class _DosierungTable extends StatelessWidget {
  ...
  final String lang;
  final AppLocalizations l10n;
  const _DosierungTable({required this.record, required this.lang, required this.l10n});
  ...
  Widget build(BuildContext context) {
    final rows = <(String, String?)>[
      ...
      (l10n.substanceDosisSchwangerschaft, record.dosierung.schwangerschaft(lang)),
    ];
    return Padding(
      padding: const EdgeInsets.only(bottom: 16),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(l10n.substanceSectionDosierung,
            style: const TextStyle(
                color: TraumColors.onBackground, fontFamily: 'DMSans', fontWeight: FontWeight.w700, fontSize: 14)),
        ...
        ...rows.map((r) => Padding(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(
                  child: Text(r.$2 ?? l10n.substanceKeineAngabe,
                      style: TextStyle(
                          color: r.$2 != null ? TraumColors.onBackgroundMuted : TraumColors.onBackgroundSubtle,
                          fontFamily: 'DMSans',
                          fontSize: 13)),
                ),
              ]),
        ...
        if (record.maxDosisHinweis != null) ...[
          ...
          Text('⚠ ${record.maxDosisHinweis}',
              style: const TextStyle(color: TraumColors.amberGold, fontFamily: 'DMSans', fontSize: 12)),
        ],
      ]),
    );
  }
...
class _TopNebenwirkungenSection extends ConsumerWidget {
  ...
  final String lang;
  final AppLocalizations l10n;
  const _TopNebenwirkungenSection({required this.record, required this.lang, required this.l10n});
      ...
      data: (repo) => FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return Padding(
            padding: const EdgeInsets.only(bottom: 16),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(l10n.substanceSectionTopNebenwirkungen,
                  style: const TextStyle(
                      color: TraumColors.onBackground,
                      fontFamily: 'DMSans',
                      fontWeight: FontWeight.w700,
              ...
              ...items.map((n) => Padding(
                    ...
                    child: Row(children: [
                      Container(
                          width: 6, height: 6,
                          decoration:
                              const BoxDecoration(color: TraumColors.coralOrange, shape: BoxShape.circle)),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(n.label(lang),
                            style: const TextStyle(
                      ...
                      if (n.meldungen != null)
                        Text('${n.meldungen}',
                            style: const TextStyle(
                                color: TraumColors.onBackgroundSubtle, fontFamily: 'DMSans', fontSize: 11)),
                    ]),
                  )),
            ]),
          );
...
class _ChemieSection extends StatelessWidget {
  ...
  const _ChemieSection(
      {required this.record, required this.expanded, required this.onToggle, required this.l10n});
  ...
  Widget build(BuildContext context) {
    ...
    if (rows.isEmpty && record.summenformel == null) return const SizedBox.shrink();
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(children: [
              Expanded(
                child: Text(l10n.substanceSectionChemie,
                    style: const TextStyle(
        ...
        if (expanded) ...[
          ...
          if (record.summenformel != null)
            _ChemieRow(label: l10n.substanceChemieSummenformel, value: record.summenformel!),
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          SizedBox(
              ...
              child: Text(label,
                  style: const TextStyle(
                      color: TraumColors.onBackgroundSubtle, fontFamily: 'DMSans', fontSize: 12))),
          Expanded(
            child: Text(value,
                style: const TextStyle(
...
class _AttributionFooter extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final hasWiki = record.quellenTags.any((t) => t.startsWith('wikipedia') || t == 'wikidata');
    if (!hasWiki && record.quellenTags.isEmpty) return const SizedBox.shrink();
    return Padding(
      padding: const EdgeInsets.only(bottom: 8),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        if (record.quellenTags.isNotEmpty)
          Wrap(spacing: 6, runSpacing: 6, children: record.quellenTags
              .map((t) => Container(
                    padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                    decoration: BoxDecoration(
                        color: TraumColors.surfaceVariant, borderRadius: BorderRadius.circular(8)),
                    child: Text(t,
                        style: const TextStyle(
        ...
        if (hasWiki) ...[
          const SizedBox(height: 8),
          Text(l10n.substanceWikipediaAttribution,
