...
final _typeFilterProvider = StateProvider.autoDispose<SubstanceKlasse?>(
  (ref) => null,
);
              ...
              children: [
                ...
                _FilterChip(
                  ...
                  onTap: () => ref.read(_typeFilterProvider.notifier).state =
                      typeFilter == SubstanceKlasse.medikament
                      ? null
                ...
                _FilterChip(
                  ...
                  onTap: () => ref.read(_typeFilterProvider.notifier).state =
                      typeFilter == SubstanceKlasse.supplement
                      ? null
                ...
                _FilterChip(
                  ...
                  onTap: () =>
                      ref.read(_pflanzlichOnlyProvider.notifier).state =
                          !pflanzlichOnly,
                ),
              ],
            ),
...
IconData _categoryIcon(String kategorie) {
  switch (kategorie) {
    ...
    case 'Herz-Kreislauf-System':
      return Icons.favorite_rounded;
    case 'Antiinfektiva (systemisch)':
      return Icons.coronavirus_rounded;
    case 'Atemwege':
      return Icons.air_rounded;
    case 'Alimentäres System und Stoffwechsel':
      return Icons.restaurant_rounded;
    case 'Muskel- und Skelettsystem':
      return Icons.fitness_center_rounded;
    case 'Blut und blutbildende Organe':
      return Icons.bloodtype_rounded;
    case 'Dermatika':
      return Icons.face_retouching_natural_rounded;
    case 'Sinnesorgane':
      return Icons.visibility_rounded;
    case 'Urogenitalsystem und Sexualhormone':
      return Icons.spa_rounded;
    case 'Antineoplastische und immunmodulierende Mittel':
...
class _SearchResults extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return resultsAsync.when(
      data: (all) {
        var results = typeFilter != null
            ? all.where((s) => s.klasse == typeFilter).toList()
            : all;
        if (pflanzlichOnly) {
          results = results.where((s) => s.pflanzlich).toList();
        }
        if (results.isEmpty) {
          return Center(
            child: Column(
